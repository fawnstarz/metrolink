    ...
    public RouteCalc getRoute(String departure, String arrival) {
        ...
        while (!pq.isEmpty()) {
            ...
            for (Edge adjacent : graph.getAdjacent(currentStation)) {
                ...
                // counts the cost of each change as int value of 1, hard coding a penalty the algorithm is hesitant to take rather than a floating point penatly
...
>>>>>>> 466afc5 (scaffolding for algorithm with fewest changes + file naming issue fix)
=======
import data.Edge;
import data.Graph;
import java.util.*;
...
>>>>>>> 85d3c97 (TASK 4&5: completed & functional algorithm + new basic input GUI for algorithm selection)
}
